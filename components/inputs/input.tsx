...
export default function Input({
  ...
  return (
    <div className="flex w-full flex-col gap-1">
      ...
      <input
        id={inputId}
        className={`rounded-md border border-slate-400 bg-white px-3 py-2 text-md outline-none focus:border-green-600 focus:ring-1 focus:ring-green-600 placeholder:text-slate-500 ${error ? "border border-red-500" : ""} ${className}`}
        {...props}
      />
