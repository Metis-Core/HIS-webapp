...
import { useActiveInventoryStores, useDepartmentQueue, usePrescriptions } from '@/hooks';
import type { IPrescription, IQueueEntryRecord } from '@/interfaces';

type TabId = 'waiting' | 'pending' | 'all';
...
export default function PharmacyPage() {
  ...
  const dispenseAll = async (p: IPrescription) => {
    if (!defaultStoreId) {
      toast.error('Configure an active inventory store first');
      return;
    }
    const items = p.items
